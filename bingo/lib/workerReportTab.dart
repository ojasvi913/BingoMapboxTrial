...
class WorkerReportTab extends StatefulWidget {
  const WorkerReportTab({Key? key}) : super(key: key);

  @override
  State<WorkerReportTab> createState() => _WorkerReportTabState();
}

class _WorkerReportTabState extends State<WorkerReportTab> {
