            ...
            : ViewPage(
                ...
                onResolve: () async {
                  if (selectedReport != null) {
                    ...
                    setState(() {
                      selectedReport = null; // Clear selected report after resolving
                    });
                  }
                },
                onSpam: () async {
                  if (selectedReport != null) {
                    await FirebaseFirestore.instance
                        .collection('reports')
                        .doc(selectedReport!['id'])
                        .update({'isSpam': true,'isResolved':Null});
                    setState(() {
                      selectedReport = null; // Clear selected report after resolving
                    });
                  }
        ...
        : Scaffold(
            ...
            body: Stack(
              children: [
                    ...
                    child: driverZipCode == null
                        ...
                        : StreamBuilder<QuerySnapshot>(
                            stream: FirebaseFirestore.instance
                                ...
                                .where('isResolved', isEqualTo: false) // Fetch unresolved reports
                                .snapshots(),
                ...
                Positioned(
                  top: screenHeight * 0.65, // Adjusted position for resolved reports
                  left: screenWidth * 0.1,
                  child: Container(
                    width: screenWidth * 0.8,
                    height: screenHeight * 0.25,
                    ...
                    child: StreamBuilder<QuerySnapshot>(
                      stream: FirebaseFirestore.instance
                          .collection('reports')
                          .where('zipCode', isEqualTo: driverZipCode)
                          .where('isResolved', isEqualTo: true) // Fetch resolved reports
                          .snapshots(),
                      builder: (context, snapshot) {
                        if (!snapshot.hasData) {
                          return const Center(child: CircularProgressIndicator());
